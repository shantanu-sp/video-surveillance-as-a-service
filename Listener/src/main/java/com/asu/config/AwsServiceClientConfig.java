...
public class AwsServiceClientConfig {
	...
	@Autowired AwsInpSqsConfig sqsConf;
	
	@Autowired AwsOpSqsConfig opSqsConf;
...
//	}
	...
	@Bean(name = "inpSqsQueueService")
	public SqsService getSqsService() {
		return new SqsServiceImpl();
	}
	
	@Bean(name = "opSqsQueueService")
	public SqsService getOPSqsService() {
		return new SqsServiceImpl();
	}
